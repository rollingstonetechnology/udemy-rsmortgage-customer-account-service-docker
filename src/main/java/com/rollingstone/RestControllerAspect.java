...
public class RestControllerAspect {
	...
	@AfterReturning("execution(public * com.rollingstone.api.rest.*Controller.createCustomerAccount*(..))")
    public void afterCallingCreateCustomerAccount(JoinPoint pjp) {
		logger.info(":::::AOP @AfterReturning Create REST call:::::" + pjp);
        counterService.increment("com.rollingstone.api.rest.CustomerAccountController.createCustomerAccount");
    }
	
	@AfterReturning("execution(public * com.rollingstone.api.rest.*Controller.getAllCustomersAccountByPage*(..))")
	...
	@AfterReturning("execution(public * com.rollingstone.api.rest.*Controller.getAllCustomerAccounts*(..))")
	...
	@AfterReturning("execution(public * com.rollingstone.api.rest.*Controller.updateCustomerAccount*(..))")
